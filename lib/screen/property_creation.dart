...
class _CloudinaryUploaderWebState extends State<CloudinaryUploaderWeb> {
  ...
  try {
    ...
    final userId = await userService.getUserIdFromToken(); // Método para obtener el ID del usuario desde el token
    ...
    final responseCode = await userService.createProperty(propertyData);
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: Text(
                      _isUploading ? 'Subiendo...' : 'Seleccionar y Subir Imagen',
                    ),
                  ),
